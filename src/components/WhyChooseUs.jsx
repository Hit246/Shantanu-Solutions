...
const WhyChooseUs = () => {
  ...
  return (
    <section id="why-choose-us" className="py-20 bg-gradient-to-br from-primary-950 to-primary-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map((reason, index) => (
            <div
              key={index}
              className="scroll-animate bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:bg-white/20 transition-all duration-300 hover:transform hover:scale-105"
            >
        ...
        <div className="mt-16 scroll-animate">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div>
                <div className="text-4xl font-bold text-accent-400 mb-2">5+ Years</div>
